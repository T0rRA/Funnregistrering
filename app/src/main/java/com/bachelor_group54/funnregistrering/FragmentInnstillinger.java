...
public class FragmentInnstillinger extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_innstillinger, container, false); //Laster inn skjermutsenet fra XML filen
